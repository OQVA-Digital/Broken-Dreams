...
ScrollReveal().reveal('.reveal_steps1', {
	distance: '50px',
	origin: 'bottom',
	opacity: 0,
	duration:1200,
...
ScrollReveal().reveal('.reveal_steps2', {
	distance: '1rem',
	origin: 'bottom',
	opacity: 0,
	duration:1300,
...
document.addEventListener('astro:after-swap', () => {reveal()}, { once: false });
